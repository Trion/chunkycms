...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('chunkycms_page', 'template',
                      self.gf('django.db.models.fields.CharField')(default='chunkycms/page.html', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.template'
        db.delete_column('chunkycms_page', 'template')
    ...
    models = {
        ...
        'chunkycms.page': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
            'template': ('django.db.models.fields.CharField', [], {'default': "'chunkycms/page.html'", 'max_length': '250'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'})
        },
